...
"CanvasJS"):(c=a.updateOption("creditText"),b=a.updateOption("creditHref"));if(a.creditHref&&a.creditText){a._creditLink||(a._creditLink=document.createElement("a"),a._creditLink.setAttribute("class","canvasjs-chart-credit"),a._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;right:2px;top:"+(a.height-14)+"px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),a._creditLink.setAttribute("tabIndex",
...
for(k=0;k<q.length;k++)l.push(parseInt(q.charCodeAt(k))-59),b+=String.fromCharCode(l[k]);n=m===b?f:0}else n=0;var r=n?(new Date(Number(n))).getTime()-g:100592E6;if(isNaN(r)||p>r){c=!0;break a}}else{k=new Date;h=k.getTime();k.setTime(h+31536E6);var s={name:A.ckDec(A.obj.ckn),val:(new Date).getTime()};document.cookie=A.ckDec(A.obj.ckn)+"="+(new Date).getTime()+"; "+A.ckDec(A.obj.ckve)+k.toUTCString()+"; path=/;";localStorage.setItem("lclStg",JSON.stringify(s))}c=!1}if(c){c=24;var w=a.plotArea.ctx;w.font=
